...
QT_MOC_LITERAL(1, 6, 9), // "returnMap"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 8), // "addValue"
QT_MOC_LITERAL(4, 26, 5) // "value"

    },
    "Store\0returnMap\0\0addValue\0value"
};
...
void Store::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->returnMap(); break;
        case 1: _t->addValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Store::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Store::returnMap)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Store::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Store::addValue)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Store::returnMap()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Store::addValue(int _t1)
{
