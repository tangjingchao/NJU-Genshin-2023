...
QT_MOC_LITERAL(1, 6, 12), // "gradeChannel"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11) // "gradeDigger"

    },
    "Grade\0gradeChannel\0\0gradeDigger"
};
...
void Grade::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Grade::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Grade::gradeChannel)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Grade::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Grade::gradeDigger)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Grade::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Grade.data,
    qt_meta_data_Grade,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void Grade::gradeChannel()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Grade::gradeDigger()
{
